...
const PostGame: NextPage<Props> = ({ score, restartQuiz }: Props) => {
    ...
    const uploadScore = async () => {
        ...
        error ? setSubmitError(true) : setSubmitSuccess(true);
        setSubmitPending(false);
    }

    return (
        <Container>
            <h2 className="text-lg text-yellow-800 text-center mt-32 mb-2">You scored {score} points!</h2>
            <div className="w-2/3 mx-auto">
                ...
                {submitError && (
                    <p className="text-center text-yellow-800 mb-4">
                        There was an error submitting your score.<br/>
