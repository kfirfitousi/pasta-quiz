...
function QuizGame() {
    ...
    if (gameState === 'pre-start') {
        return (
            <Container>
                ...
                <p className="md:w-2/3 mx-auto text-center text-yellow-800 mb-2">
                    There are 10 rounds, in each one you must name the pasta shape within 15
                    seconds.
                </p>
        ...
        return (
            <Container>
                <h1 className="text-4xl text-yellow-800 text-center mt-52 select-none">
                    {countdown}
                </h1>
            </Container>
        );
        ...
        return <PostGame score={score} restartQuiz={startQuiz} gameData={gameData} />;
    }
}
